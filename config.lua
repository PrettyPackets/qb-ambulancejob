...
Config.PS_UI = true -- If you use PS_UI and want Minigames Implemented otherwise it wont have any.
Config.BankingExport = "qb-banking"
Config.OkOkBanking = true -- If true will ignore the banking export above
Config.AutoLeaveBed = true -- If you want them to auto get out of bed, or have to press button
Config.PrettyLib = true -- If you want to use OX Inventory or other inventories otherwise it will use QB-Inventory
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        vector3(-488.9652, -987.9431, 24.5014), -- Aldore
    },
    ['duty'] = {
        vector3(-485.3649, -1004.2628, 33.4884), -- Aldore
    },
    ['vehicle'] = {
    ...
    ['beds'] = {
		--Aldore
        { coords = vector4(-458.75, -1024.17, 34.60, 180.82),   taken = false, model = 2117668672 },
        { coords = vector4(-454.96, -1023.99, 34.60, 182.35),   taken = false, model = 2117668672 },
        { coords = vector4(-451.14, -1024.07, 34.60, 177.36),   taken = false, model = 2117668672 },
        { coords = vector4(-447.32, -1024.00, 34.60, 177.52),   taken = false, model = 2117668672 },
        { coords = vector4(-447.40, -1030.15, 34.60, 1.20),   taken = false, model = 2117668672 },
        { coords = vector4(-451.14, -1030.30, 34.60, 0.11),   taken = false, model = 2117668672 },
        { coords = vector4(-455.09, -1029.98, 34.60, 355.15),   taken = false, model = 2117668672 },
        { coords = vector4(-458.81, -1030.11, 34.60, 358.00),   taken = false, model = 2117668672 },
    ...
    ['hospital'] = {
        {
            ...
            ['location'] = vector3(-458.81, -1030.11, 34.60),
            ['beds'] = {				
				{ coords = vector4(-458.75, -1024.17, 34.60, 180.82),   taken = false, model = 2117668672 },
				{ coords = vector4(-454.96, -1023.99, 34.60, 182.35),   taken = false, model = 2117668672 },
				{ coords = vector4(-451.14, -1024.07, 34.60, 177.36),   taken = false, model = 2117668672 },
    ...
    ['stations'] = {
        { label = "Aldore Hospital", coords = vector3(-458.81, -1030.11, 34.60) },
    }
}
